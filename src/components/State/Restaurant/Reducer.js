...
const restaurantReducer = (state = initailState, action) => {
  switch (action.type) {
    ...
    case actionTypes.GET_RESTSAURANT_BY_ID_REQUEST:
    ...
    case actionTypes.GET_RESTSAURANT_BY_ID_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    case actionTypes.CREATE_EVENTS_SUCCESS:
      return {
        ...
        restaurantsEvents: [...state.restaurants, action.payload],
      };
    ...
    case actionTypes.GET_RESTSAURANT_BY_ID_FAILURE:
